...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  primaryLinks.forEach(link => {
    link.addEventListener('click', (ev) => {
      ...
      // allow home link (gonepal.html, hello.html or '#') without login
      const isHome = href === '' || href === '#' || href.endsWith('gonepal.html') || href.endsWith('hello.html');
  ...
  // Restrict festival links on home page to logged-in users
  const festivalLinks = document.querySelectorAll('a[href*="festivals.html"]');
  ...
  // Restrict heritage links on home page to logged-in users
  const heritageLinks = document.querySelectorAll('a[href*="heritages.html"]');
  ...
  // Restrict "View All" links for festivals and heritages (same restriction as primary nav)
